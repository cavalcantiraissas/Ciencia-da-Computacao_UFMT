...
| Árvore | Código | Funções | Contagem de rotações |
|---|---|---|---|
| Árvore Binária de Busca (ABB) | `add.c` | Inserção, busca, cálculo da altura e percurso em ordem | Não aplicável |
| Árvore AVL | `avl.c` | Inserção com balanceamento, busca, cálculo da altura e percurso em ordem | Implementada |
| Árvore Rubro-Negra (ARN) | `arn.c` | Inserção com balanceamento, busca, cálculo da altura e percurso em ordem | Implementada |
...
Compile e execute os códigos como na Etapa 2, e verifique a saída para a altura da árvore e o número de rotações.
...
O código de cada árvore já implementa essa etapa; basta compilar e executar como na Etapa 2.

## Documentação

- [`Árvores-Binárias-Relatório.pdf`](./Árvores-Binárias-Relatório.pdf) — relatório com a análise comparativa de desempenho e busca entre as três árvores.

---

[Voltar para Estrutura de Dados II](../README.md)
