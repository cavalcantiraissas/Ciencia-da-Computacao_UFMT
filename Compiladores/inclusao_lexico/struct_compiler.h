...
#define MAX_CHAR 32
#define MAX_TOKEN 32
#define MAX_SRC 4096 // tamanho maximo do codigo fonte carregado do arquivo
...
struct st_token {
    ...
    int pos; // posicao (coluna) do inicio do token no codigo fonte, usada nas mensagens de erro
};
